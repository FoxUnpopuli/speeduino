...
class FramClass
{
  public:
    FramClass();
    #if defined(ARDUINO_ARCH_STM32) || defined(__IMXRT1062__) || defined(CORE_SAM) // Added the SAM D51
...
//    #define deassertCS *csPort |= (csMask); //fastWrite(csPort, csMask, HIGH);
    ...
    #if defined(ARDUINO_ARCH_STM32) || defined(__IMXRT1062__) || defined(CORE_SAM) // Added the SAM
